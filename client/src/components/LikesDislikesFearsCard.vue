...
const sauce = computed(() => AppState.activeSauce)
const tool = computed(() => AppState.activeTool)
const like = computed(() => AppState.like)

onMounted(() => {
  AppState.bugsnax = null
  AppState.grumpuses = null
  AppState.sauces = null
  AppState.tools = null
  choosePropType()
})
...
<template>
  <div v-if="bugsnaxProp != null && like != null">
    <RouterLink :to="{ name: 'BugsnaxDetails', params: { bugsnaxId: like?.id } }">
      <div class="card mt-3 mb-3">
        <img class="cover-img" :src="like?.picture" alt="">
        <!-- <div class="card-body">
  ...
  <div v-if="grumpusProp != null && like != null">
    <RouterLink :to="{ name: 'GrumpusDetails', params: { grumpusId: like?.id } }">
      <div class="card mt-3 mb-3">
        <img class="cover-img" :src="like?.picture" alt="">
        <!-- <div class="card-body">
          <h5 class="card-title arco-font">{{ like?.name }}</h5>
  ...
  <div v-if="sauceProp != null && like != null">
    <RouterLink :to="{ name: 'SauceDetails', params: { sauceId: like?.id } }">
      <div class="card mt-3 mb-3">
        <img class="cover-img" :src="like?.picture" alt="">
        <!-- <div class="card-body">
          <h5 class="card-title arco-font">{{ like?.name }}</h5>
  ...
  <div v-if="toolsProp != null && like != null">
    <RouterLink :to="{ name: 'ToolDetails', params: { toolId: like?.id } }">
      <div class="card mt-3 mb-3">
        <img class="cover-img" :src="like?.picture" alt="">
        <!-- <div class="card-body">
          <h5 class="card-title arco-font">{{ like?.name }}</h5>
